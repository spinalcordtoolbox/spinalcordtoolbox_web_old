...
<div class="alert alert-warning" style="margin-top: 50px;">This Website is still under development!</div>
...
<div id="brainbrowser-field" >
    <script id="volume-ui-template" type="x-volume-ui-template">
        ...
        <div class="volume-viewer-controls volume-controls col-md-3">
            ...
            <div class="coords">
                <legend class="control-heading" id="voxel-coordinates-heading-{{VOLID}}">
                    Voxel Coordinates:
                </legend>
                ...
                <br/>
                <legend class="control-heading" id="world-coordinates-heading-{{VOLID}}">
                    World Coordinates:
                </legend>
        ...
        <div id="tab-spinal-field" class="tab-content" style="overflow-y:auto; overflow-x:hidden;   max-height:900px; " >
            <div class="tab-pane active" id="tabNavigation" ng-controller="uploadCtrl" >
                ...
                <div class="row" id='nav-buttons-field'>
                    <div class="col-md-offset-0 col-md-12" style="margin-left: 5px;">
                        <form id = "uploadForm" >
                            <br/>
            ...
            <div class="tab-pane" id="tabProcess">
                <div class="row" id="process-field" >
                    <div ng-controller="PostsCtrl" id="commandInputGenerator" class="col-md-offset-0 col-md-12 " style="margin-left: 5px;">
                        <br/>
                ...
                <div class="tab-pane" id="tabOutput">
                    <div ng-controller="logController" id="log">
                        {{consoleLog}}
                    </div>
            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a id="console" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                        ...
                        Expert mode - Click to show/hide the terminal
                    </a>
                </h4>
            </div>
...
<div style = "visibility : hidden" id = "PostsCtrl" ng-controller = "PostsCtrl">
</div>
