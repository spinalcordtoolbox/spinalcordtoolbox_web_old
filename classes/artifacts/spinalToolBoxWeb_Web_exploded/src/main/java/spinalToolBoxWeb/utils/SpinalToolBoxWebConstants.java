...
public class SpinalToolBoxWebConstants {
    ...
    public static final String COMMAND_NULL = "Can't run null command. You got to know what you want";
    public static String VIEW_COMPARE_RESULT ="compareResult";

    public static final String SERVER_RESPONSE_UNDEFINED = "undefined";
