/*
    THIS FILE CONTAINS VOLUMES OPERATIONS MODELS
 */


/*
    THIS FUNCTION GENERATES THE STARTUP IMAGE PARAMETER.
    THIS PARAMETER IS NECESSARY TO BRAINBROWSER MODULE TO SHOW THE STARTUP IMAGE.
 */
...
/*
    THIS FUNCTION GENERATE PARAMETER OF THE SELECTED IMAGE BY USER.
    THIS PARAMETER IS NECESSARY TO BRAINBROWSER MODULE TO GET THE SELECTED IMAGES FROM DISTANT SERVER
    AND DOING MANIPULATIONS ON THEM.
    THIS FUNCTION IS CALLED IN processing(...) function.
 */
...
/*
    THIS FUNCTION IS CALLED EVERYTIME USER UPDATE UI UPLOADED IMAGES CHECKLIST TO SHOW UP SELECTED IMAGE(S) (IF EXISTS)
    IT IS CALLED IN displayVolume(...) FUNCTION.
 */
processing = function(serviceSharedProperties)
{
    ...
    if(selected.length == 0)
    {
        ...
        //alert("WARNING: the control panel is only active if a single image is checked");
    }
...
/*
    THIS FUNCTION DISPLAY THE SELECTED IMAGES BY THE USER.
 */
...
/*
    THIS FUNCTION UPDATE THE LIST OF SELECTED FILES BY THE USER
 */
